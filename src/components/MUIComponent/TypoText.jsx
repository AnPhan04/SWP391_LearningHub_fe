...
const TypoContent = styled.h3 `font-family: inter, sans-serif; font-size: ${(props) => getFontSize(props.variant)}; color: ${(props) => props.color}; font-weight: ${(props) => getFontWeight(props.variant)};`;
